...
%-----------------------------------------------------------------------
function matlabbatch = GLM_Rating15_job(ID,ExSep,outputdir,prefix,onsetdir)
       
%         all_values = [A.names, B.names, C.names];
%         unique_values = unique([all_values{:}]);
%         tbl_unique = array2table(unique_values', 'VariableNames', {'UniqueValues'});
            clear matlabbatch
            ...
            %run01=[prefix 's8_sub-601_task-NAPS_run-02_space-MNI152NLin2009cAsym_res-2_desc-preproc_bold_S8.nii'];
            ...
            matlabbatch{2}.spm.stats.fmri_spec.timing.fmri_t = 36;%%%%%%%%%%%%%%%slice num
            ...
            matlabbatch{2}.spm.stats.fmri_spec.sess(1).multi_reg = {covfiles1};%%%%%%%%%%%%%%%%%%%covfiles1
            ...
            matlabbatch{2}.spm.stats.fmri_spec.mthresh = 0;%%%%%%%%%%%%%%%%%%%%%%0.8
            matlabbatch{2}.spm.stats.fmri_spec.mask = {'E:\PAIN\Control_group_artical\VIES\Data\rGM_mask(2mm).nii'};%%%%%%%%%mask
            ...
            if length(unique_values) == 6
                ...
                matlabbatch{4}.spm.stats.con.consess{1}.tcon.weights = weight;%weight/a
